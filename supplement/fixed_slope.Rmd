...
residualVarPlot <- function(vst.out, xaxis="gmean", max_resvar=30, ntop = 30, annotate = F) {
...
2) offset-vartheta: SCTransform with log_umi as an offset using glmGamPoi
3) offset10: Offset model with with $\theta=10$
3) fixed-slope: SCTransform with `method="glmGamPoi"` and `fix_slope=TRUE`, that will
...
4) fixed-intercept: SCTransform with `method="glmGamPoi"` and `fix_intercept=TRUE`, that will
...
5) fixed-interceptandslope: SCTransform with `method="glmGamPoi"` and `fix_intercept=TRUE`, that will
...
vst_out[["offset-vartheta"]] <- vst(umi = cm, n_genes = 2000, method = "glmGamPoi_offset", exclude_poisson = FALSE, verbosity = 0)

vst_out[["offset10"]] <- vst(umi = cm, n_genes = 2000, method = "offset", theta_given = 10, exclude_poisson = FALSE, verbosity = 0)

vst_out[["fixed-intercept"]] <- vst(umi = cm, n_genes = 2000, method = "glmGamPoi", exclude_poisson = FALSE, fix_intercept = TRUE, verbosity = 0)

vst_out[["fixed-slope"]] <- vst(umi = cm, n_genes = 2000, method = "glmGamPoi", exclude_poisson = FALSE, fix_slope = TRUE, verbosity = 0)

vst_out[["fixed-interceptandslope"]] <- vst(umi = cm, n_genes = 2000, method = "glmGamPoi", exclude_poisson = FALSE, fix_slope = TRUE, fix_intercept = TRUE, verbosity = 0)
```
